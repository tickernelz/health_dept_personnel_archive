...
@push('title', 'Tambah Surat Menduduki Jabatan')

@section('main-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ $title ?? __('Blank Page') }}</h1>

    <form action="{{ route('mendudukijabatan.store') }}" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nip_pengirim') is-invalid @enderror" name="nip_pengirim"
                           id="nip_pengirim"
                           placeholder="Masukkan NIP Pengirim..." autocomplete="off" value="{{ old('nip_pengirim') }}">
                    @error('nip_pengirim')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama_pengirim') is-invalid @enderror" name="nama_pengirim"
                           id="nama_pengirim"
                           placeholder="Masukkan Nama Pengirim..." autocomplete="off" value="{{ old('nama_pengirim') }}">
                    @error('nama_pengirim')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('pangkat_pengirim') is-invalid @enderror" name="pangkat_pengirim"
                           id="pangkat_pengirim"
                           placeholder="Masukkan Pangkat Pengirim..." autocomplete="off" value="{{ old('pangkat_pengirim') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('jabatan_pengirim') is-invalid @enderror" name="jabatan_pengirim"
                           id="jabatan_pengirim"
                           placeholder="Masukkan Jabatan Pengirim..." autocomplete="off" value="{{ old('jabatan_pengirim') }}">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nip_penerima') is-invalid @enderror" name="nip_penerima"
                           id="nip_penerima"
                           placeholder="Masukkan NIP Penerima..." autocomplete="off" value="{{ old('nip_penerima') }}">
                    @error('nip_penerima')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama_penerima') is-invalid @enderror" name="nama_penerima"
                           id="nama_penerima"
                           placeholder="Masukkan Nama Penerima..." autocomplete="off" value="{{ old('nama_penerima') }}">
                    @error('nama_penerima')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('pangkat_penerima') is-invalid @enderror" name="pangkat_penerima"
                           id="pangkat_penerima"
                           placeholder="Masukkan Pangkat Penerima..." autocomplete="off" value="{{ old('pangkat_penerima') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('jabatan_penerima') is-invalid @enderror" name="jabatan_penerima"
                           id="jabatan_penerima"
                           placeholder="Masukkan Jabatan Penerima..." autocomplete="off" value="{{ old('jabatan_penerima') }}">
