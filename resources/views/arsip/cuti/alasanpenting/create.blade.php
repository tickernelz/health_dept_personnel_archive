...
@push('title', 'Tambah Cuti Alasan Penting')
...
@section('main-content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('cutialasanpenting.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nomor_induk') is-invalid @enderror"
                           ...
                           placeholder="Masukkan Nomor Induk..." autocomplete="off" value="{{ old('nomor_induk')}}">
                    @error('nomor_induk')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('divisi') is-invalid @enderror"
                           ...
                           placeholder="Masukkan Divisi..." autocomplete="off" value="{{ old('divisi')}}">
                    @error('divisi')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <a href="{{ route('cutialasanpenting.index') }}" class="btn btn-default">Kembali</a>
