...
@push('title', 'Tambah Cuti Tahunan')
...
@section('main-content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('cutitahunan.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <a href="{{ route('cutitahunan.index') }}" class="btn btn-default">Kembali</a>
