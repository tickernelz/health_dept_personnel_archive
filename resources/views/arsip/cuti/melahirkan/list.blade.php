...
@push('title', 'List Cuti Melahirkan')
            ...
            <table class="table table-bordered table text-center" id="table">
                ...
                @foreach ($data as $li)
                    <tr>
                        ...
                        <td>
                            @if (isset($li->file))
                                <div class="text-center">
                                    <embed src="{{ asset('/file/cuti/melahirkan/'.$li->file) }}" width="200" height="200"
                                           alt="pdf"/>
                                </div>
                                <div class="text-center">
                                    <div class="btn-group btn-group-sm" role="group">
                                        <a type="button" class="btn btn-sm btn-secondary"
                                           href="/file/cuti/melahirkan/{{$li->file}}">
                                            Lihat
                                        </a>
                                        <a type="button" class="btn btn-sm btn-secondary"
                                           href="{{ route('cutimelahirkan.hapus_file', $li->id) }}"
                        ...
                        <td>
                            <form action="{{ route('cutimelahirkan.destroy', $li->id) }}" method="post">
                                <div class="btn-group btn-group-sm" role="group">
                                    <a href="{{ route('cutimelahirkan.edit', $li->id) }}" class="btn btn-primary">Edit</a>
                                    @csrf
                                    @method('delete')
