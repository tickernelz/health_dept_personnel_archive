            ...
            <form action="{{ route('suratkeluar.update', $data->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nomor_surat') is-invalid @enderror"
                           ...
                           placeholder="Masukkan Nomor Surat..." autocomplete="off" value="{{ old('nomor_surat') ?? $data->nomor_surat}}" @hasrole('Admin') readonly @endhasrole>
                    @error('nomor_surat')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group date">
                        <input onkeydown="return false" type="text"
                               class="form-control datepicker @error('tanggal_keluar') is-invalid @enderror"
                               name="tanggal_keluar" id="tanggal_keluar"
                               placeholder="Keluarkan Tanggal Keluar..." autocomplete="off"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('perihal') is-invalid @enderror" name="perihal" id="perihal"
                              rows="3" @hasrole('Admin') readonly @endhasrole>{{ old('perihal') ?? $data->perihal}}</textarea>
                    @error('perihal')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <a href="{{ route('suratkeluar.index') }}" class="btn btn-default">Kembali</a>
