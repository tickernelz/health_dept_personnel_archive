...
@push('title', 'Tambah Surat Keluar')
            ...
            <form action="{{ route('suratkeluar.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('kode') is-invalid @enderror" name="kode" id="kode"
                           placeholder="Masukkan Kode..." autocomplete="off" value="{{ old('kode') }}">
                    @error('kode')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nomor_surat') is-invalid @enderror"
                           ...
                           placeholder="Masukkan Nomor Surat..." autocomplete="off" value="{{ old('nomor_surat')}}">
                    @error('nomor_surat')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group date">
                        <input onkeydown="return false" type="text"
                               ...
                               placeholder="Masukkan Tanggal Keluar..." autocomplete="off"
